...
const displayedModifiedCount = computed(() => props.modifiedCount ?? designerStore.groupCount(props.group.id))
...
function reset() {
  ...
  designerStore.resetGroup(props.group.id)
}
</script>
